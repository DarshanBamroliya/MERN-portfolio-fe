...
function AboutUs() {
  return (
    <section id="about" className="md:py-20 py-10 px-4 sm:px-6 lg:px-8 bg-white border-t border-gray-100">
      <div className="mx-auto grid grid-cols-12 gap-6 md:gap-8">
